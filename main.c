...
static const unsigned char amperkot_logo_bits[] = {
...
int main(void) {
    ...
    while(1) {
        if (cur_x < amperkot_logo_width && cur_y < amperkot_logo_height) {
            SPI_send_byte(amperkot_logo_bits[cur_x + cur_y * amperkot_logo_width]);
        }
        else {
            SPI_send_byte(0);
        }
